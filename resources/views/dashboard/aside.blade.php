                    ...
                    <ul id="sidebarnav">
                        ...
                        <li @if($data['item'] == 'booking') class="active" @endif >
                            ...
                            <ul class="collapse @if($data['item'] == 'booking') in @endif " @if($data['item'] == 'booking') aria-expanded="true" @else aria-expanded="false" @endif >
                                <li @if($data['subitem'] == 'booking/index') class="active" @endif ><a @if($data['subitem'] == 'booking/index') class="active" @endif  href="/booking/index"><i class="fa fa-caret-right fa-fw"></i> Reservar por Dia</a></li>
                                <li @if($data['subitem'] == 'booking_date/index') class="active" @endif ><a @if($data['subitem'] == 'booking_date/index') class="active" @endif href="/booking_date/index"><i class="fa fa-caret-right fa-fw"></i> Reservar por Rango</a></li>
                            </ul>
                        </li>
                        <li @if($data['item'] == 'rewards') class="active" @endif >
                            ...
                            <ul class="collapse @if($data['item'] == 'rewards') in @endif " @if($data['item'] == 'booking') aria-expanded="true" @else aria-expanded="false" @endif >
                                <li @if($data['subitem'] == 'rewards/index') class="active" @endif ><a @if($data['subitem'] == 'rewards/index') class="active" @endif href="/rewards/index"><i class="fa fa-caret-right fa-fw"></i> Recompensas</a></li>
                                <li @if($data['subitem'] == 'tests/index') class="active" @endif ><a @if($data['subitem'] == 'tests/index') class="active" @endif href="/tests/index"><i class="fa fa-caret-right fa-fw"></i> Evaluaciones</a></li>
                                <li @if($data['subitem'] == 'tests_report/index') class="active" @endif ><a @if($data['subitem'] == 'tests_report/index') class="active" @endif href="/tests_report/index"><i class="fa fa-caret-right fa-fw"></i> Reporte</a></li>
                            </ul>
                        </li>
