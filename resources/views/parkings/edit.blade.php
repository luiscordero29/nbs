...
@section('breadcrumb')
    <div class="col-md-9 col-9 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">Editar Parqueadero</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/dashboard">Administración</a></li>
            <li class="breadcrumb-item"><a href="/parkings/index">Divisiones</a></li>
            <li class="breadcrumb-item active">Editar Parqueadero </li>
        </ol>
    </div>
...
@endsection
@section('content')
	<form method="POST" action="/parkings/update/{{ $data['row']->parking_id }}"  enctype="multipart/form-data">
		{{ csrf_field() }}
        <div class="form-body">
            <h3 class="card-title">Editar Parqueadero</h3>
            <hr>
            @if ($errors->any())
            ...
            <div class="row p-t-20">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="custom-select select2 col-12" name="parking_dimension_name">
                            ...
                            <option @if ($data['row']->parking_dimension_name == $r->parking_dimension_name ) selected=""  @endif value="{{$r->parking_dimension_name}}">{{$r->parking_dimension_name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="custom-select select2 col-12" name="parking_section_name">
                            ...
                            <option @if ($data['row']->parking_section_name == $r->parking_section_name ) selected=""  @endif value="{{$r->parking_section_name}}">{{$r->parking_section_name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="parking_name" name="parking_name" class="form-control" placeholder="Nombre del la Parqueadero" type="text" value="{{ $data['row']->parking_name }}">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="parking_description" name="parking_description" class="form-control" placeholder="Descripción del Parqueadero" type="text" value="{{ $data['row']->parking_description }}">
        ...
        <div class="form-actions">
            ...
            <input type="hidden" name="parking_id" value="{{ $data['row']->parking_id }}">
        </div>
    </form>
@endsection
@section('script')
