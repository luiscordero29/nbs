            ...
            <div class="row p-t-20">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="user_charge_description" name="user_charge_description" class="form-control" placeholder="Descripción" type="text" value="{{ old('user_charge_description') }}" autofocus="">
