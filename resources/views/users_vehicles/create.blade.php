...
@section('breadcrumb')
    <div class="col-md-9 col-9 align-self-center">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/dashboar') }}d">Administración</a></li>
...
@endsection
@section('content')
    <form method="POST" action="{{ url('/users_vehicles/store/'.$data['row']->user_uid} }}" enctype="multipart/form-data">
		{{ csrf_field() }}
        <div class="form-body">
        ...
        <div class="form-actions p-t-20">
            ...
            <a href="{{ url('/vehicles/index/'.$data['row']->user_uid) }}" class="btn btn-inverse">Regresar</a>
