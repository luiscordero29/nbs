...
@endsection
@section('content')
    <form method="POST" action="/users_vehicles/store/{{ $data['row']->user_uid }}" enctype="multipart/form-data">
		{{ csrf_field() }}
        <div class="form-body">
        ...
        <div class="form-actions p-t-20">
            ...
            <a href="/vehicles/index/{{ $data['row']->user_uid }}" class="btn btn-inverse">Regresar</a>
