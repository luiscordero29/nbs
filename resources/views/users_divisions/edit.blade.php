...
@endsection
@section('content')
	<form method="POST" action="/users_divisions/update/{{ $data->user_division_id }}">
		{{ csrf_field() }}
        <div class="form-body">
            ...
            <div class="row p-t-20">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="user_division_description" name="user_division_description" class="form-control" placeholder="Descripción" type="text" value="{{ $data->user_division_description }}" autofocus="">
        ...
        <div class="form-actions">
            ...
            <input type="hidden" name="user_division_id" value="{{ $data->user_division_id }}">
        </div>
    </form>
@endsection