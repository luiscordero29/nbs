            ...
            <div class="row p-t-20">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="user_division_description" name="user_division_description" class="form-control" placeholder="Descripción" type="text" value="{{ $data->user_division_description }}">
