    ...
    <div class="col-12">
        <div class="card">
            <div class="card-block">
                <form id="form-booking-search" method="POST" action="{{ url('/booking/index') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="booking_create" method="POST" action="{{ url('/booking/store') }}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
...
<div id="modal-booking-update" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-booking-update" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="booking_update" method="POST" action="{{ url('/booking/update') }}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label">Empleado</label>
...
<!-- booking-delete -->
<form id="booking_delete" method="POST" action="{{ url('/booking/destroy') }}">
    {{ csrf_field() }}
...
<script type="text/javascript">
    ...
    $("#booking_user_uid").change(function(even) {
        ...
        $.getJSON( "{{ url('/booking/getvehicles/') }}" + "/" + user_uid + '/' + booking_date , function( data ) {
    ...
    $( ".btn-booking-create" ).on( "click", function( e ) {
        ...
        console.log( 'parking_uid: ' + parking_uid );
