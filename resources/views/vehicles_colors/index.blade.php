                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a class="btn btn-secondary" href="/vehicles_colors/show/{{ $r->vehicle_color_uid }}" data-toggle="tooltip" data-original-title="Ver"> <i class="fa fa-eye text-inverse"></i> </a>
                                <a class="btn btn-secondary" href="/vehicles_colors/edit/{{ $r->vehicle_color_uid }}" data-toggle="tooltip" data-original-title="Editar"> <i class="fa fa-pencil text-inverse"></i> </a>
                                <a class="btn btn-secondary" href="/vehicles_colors/destroy/{{ $r->vehicle_color_uid }}" data-toggle="tooltip" data-original-title="Eliminar"> <i class="fa fa-close text-danger"></i> </a>
                            </div>
                        </td>
                    </tr>             
				@endforeach
