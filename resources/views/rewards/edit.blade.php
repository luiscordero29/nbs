...
@endsection
@section('content')
	<form method="POST" action="{{ url('/rewards/update/'.$data['row']->reward_uid) }}"  enctype="multipart/form-data">
		{{ csrf_field() }}
        <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('reward_name')) has-danger @endif">
                            ...
                            <input id="reward_name" name="reward_name" class="form-control" placeholder="Nombre de la Recompensa" type="text" value="{{ $data['row']->reward_name }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group @if($errors->has('reward_ammount')) has-danger @endif">
                            ...
                            <input id="reward_ammount" name="reward_ammount" class="form-control" placeholder="Crédito de la Recompensa" type="text" value="{{ $data['row']->reward_ammount }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group @if($errors->has('reward_status')) has-danger @endif">
                            ...
                            <select class="custom-select col-12" name="reward_status">
                                ...
                                <option @if ($data['row']->reward_status == 1 ) selected=""  @endif value="1">Habilitado</option>
                                <option @if ($data['row']->reward_status == 0 ) selected=""  @endif value="0">Desabilitado</option>
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('reward_description')) has-danger @endif">
                            ...
                            <input id="reward_description" name="reward_description" class="form-control" placeholder="Descripción de la Recompensa" type="text" value="{{ $data['row']->reward_description }}">
